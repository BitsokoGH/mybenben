 ...
 @section('content')
        <div class="row">
            <div class="col-md-5 serachBox">
                ...
                <h3 class="text-center">223,463 properties surveyed</h3>
                <div class="row">
                    <div class="col-md-4">
                        <h5 class="text-center">Registered vs Unregistered</h5>
                        <canvas id="landtitle" width="150" height="150"></canvas>
                    </div> 
                    <div class="col-md-4">
                        <h5 class="text-center">Insured vs Uninsured</h5>
                        <canvas id="insurance" width="150" height="150"></canvas>
                    </div>  
                    <div class="col-md-4"></div>  
                    <h5 class="text-center">Delinquent vs Ontime</h5>
                    <canvas id="delinquency" width="150" height="150"></canvas>

                </div>

                <div class="row infoKeys">
                    <div class="col-md-4" data-key="lot-dumping">
                        <i class="glyphicon glyphicon-trash"></i><div class="small">Lots with Dumping:</div>
                        <div class="number">2,555</div>
                    </div>
                    <div class="col-md-4" data-key="fire">
                        <i class="glyphicon glyphicon-fire"></i><div class="small">Structures with Fire Damage:</div>
                        <div class="number">3,723</div>
                    </div>
                    <div class="col-md-4" data-key="boarding">
                        <i class="glyphicon glyphicon-exclamation-sign"></i><div class="small">Structures needing Boarding:</div>
                        <div class="number">11,418</div>
                    </div>     
...
<script>
        ...
        <script>
            ...
            var context = document.getElementById('insurance').getContext('2d');
            var insuranceChart = new Chart(context).Pie(pieData);
            ...
            var context = document.getElementById('delinquency').getContext('2d');
            var delinquencyChart = new Chart(context).Pie(pieData);
            ...
            var context = document.getElementById('landtitle').getContext('2d');
            var landtitleChart = new Chart(context).Pie(pieData);
        </script>
