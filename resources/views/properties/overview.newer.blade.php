...
@section('custom_js')
        ...
        <script src="{{url('../assets/js/chart/Chart.js')}}" type="text/javascript"></script> 
    ...
    var div = L.DomUtil.create('div', 'info legend'),
        grades = ["residential", "commercial", "mixed","industrial","institutional","other","unknown", "vacant","parking", "park"  ],
        mycolors = ["#b30059", "#5073e6", "#e6e620", "#5c00b3", "#2db802", "#0074b3", "gold", "#e66c15", "#e3e6e1", "red"],
